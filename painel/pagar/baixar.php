...
//LANÇAR NAS MOVIMENTAÇÕES
	$pdo->query("INSERT INTO movimentacoes set tipo = 'Saída', movimento = 'Conta à Pagar', descricao = '$descricao', valor = '$subtotal', usuario = '$id_usuario', data = '$data_baixar', lancamento = '$saida', id_mov = '$id'");
