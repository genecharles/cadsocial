...
$query = $pdo->prepare("INSERT INTO $tabela SET nome = :nome, setor = '1', categoria = '1',  fornecedor = '$fornecedor', data_cad = curDate(), usuario_cad = '$id_usuario', arquivo = '$foto', tipo = 'Conta à Pagar', id_reg = '$id'");
	$acao = 'inserção';
