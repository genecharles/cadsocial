...
$query = $pdo->prepare("INSERT INTO $tabela SET nome = :nome, setor = '1', categoria = '1',  funcionario = '$id', data_cad = curDate(), usuario_cad = '$id_usuario', arquivo = '$foto', tipo = 'Funcionário', id_reg = '$id'");
	$acao = 'inserção';
